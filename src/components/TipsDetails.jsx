    ...
    const fetchTipDetails = async () => {
      try {
        ...
        const response = await fetch(
          `https://gardening-hub-server-indol.vercel.app/singleData/${id}`
        );
        if (!response.ok) {
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {tip.category && (
              <div className="text-center">
                <svg
                  className="w-8 h-8 mx-auto mb-2 text-green-600 dark:text-green-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            {tip.author && (
              <div className="text-center">
                <svg
                  className="w-8 h-8 mx-auto mb-2 text-purple-600 dark:text-purple-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            {tip.date && (
              <div className="text-center">
                <svg
                  className="w-8 h-8 mx-auto mb-2 text-yellow-600 dark:text-yellow-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            {tip.likes !== undefined && (
              <div className="text-center">
                <svg
                  className="w-8 h-8 mx-auto mb-2 text-red-600 dark:text-red-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
            ...
            {tip.views !== undefined && (
              <div className="text-center">
                <svg
                  className="w-8 h-8 mx-auto mb-2 text-indigo-600 dark:text-indigo-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 mb-8 border border-gray-100 dark:border-gray-700">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base sm:text-lg whitespace-pre-line">
              {tip.description ||
                "No detailed description available for this gardening tip."}
            </p>
          </div>
        </div>
