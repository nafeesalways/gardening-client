  ...
  const tools = [
    {
      ...
      name: "Pruning Shears",
      description:
        "Essential for trimming plants and shrubs with ease and precision.",
      icon: "✂️",
    ...
    },
    {
      ...
      description:
        "Get accurate pH and moisture readings for optimal plant growth.",
      icon: "🧪",
    ...
    },
    {
      ...
      name: "Garden Spade",
      description:
        "Reliable digging and edging tool for all your gardening tasks.",
      icon: "🔱",
    ...
    },
    {
      ...
      description:
        "Protect your hands while working in the soil and handling plants.",
      icon: "🧤",
    ...
    },
    {
      ...
      name: "Hand Rake",
      description:
        "Compact and efficient for loosening soil and removing weeds.",
      icon: "🌾",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base max-w-2xl mx-auto">
            Equip yourself with the right tools to make gardening easier and
            more enjoyable
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {tools.map((tool) => (
            ...
            >
              {/* Icon Background */}
              <div
                className={`bg-gradient-to-br ${tool.color} p-6 text-center relative overflow-hidden`}
              >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div>
              ...
              <p className="text-green-100 text-sm sm:text-base">
                Good gardening tools make the work easier and more enjoyable.
                Choose quality tools that will last for years and make a real
