    ...
    return (
      <section className="py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg">No trending tips available</p>
        </div>
      </section>
    );
  }
          ...
          {tips.map((tip) => (
            ...
            >
              ...
              <div className="relative overflow-hidden h-48 bg-gray-200 dark:bg-gray-700">
                <img
                  src={tip.imageUrl || "https://via.placeholder.com/400x300?text=Garden+Tip"}
                  alt={tip.title}
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex gap-3">
                  ...
                  >
                    <svg className="w-4 h-4" fill={likedTips.has(tip._id) ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
